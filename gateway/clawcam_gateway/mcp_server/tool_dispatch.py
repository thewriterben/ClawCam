...
def dispatch_tool(
    ...
    dispatch: dict[str, Callable[..., dict[str, Any]]] = {
        ...
        "get_calibration_report": lambda **kw: get_calibration_report(context, **kw),
        "get_anomaly_report": lambda **kw: get_anomaly_report(context, **kw),
        "get_cooccurrence_report": lambda **kw: get_cooccurrence_report(context, **kw),
        "get_abundance_report": lambda **kw: get_abundance_report(context, **kw),
        "get_environment_report": lambda **kw: get_environment_report(context, **kw),
        "get_weather_activity_report": lambda **kw: get_weather_activity_report(context, **kw),
        "get_habitat_report": lambda **kw: get_habitat_report(context, **kw),
        "run_federated_round": lambda **kw: run_federated_round(context, **kw),
        "get_species_profile": lambda **kw: get_species_profile(context, **kw),
        "list_sites": lambda **kw: list_sites(context, **kw),
        "get_site_events": lambda **kw: get_site_events(context, **kw),
        "list_device_positions": lambda **kw: list_device_positions(context, **kw),
        "get_site_devices": lambda **kw: get_site_devices(context, **kw),
        "get_fused_detections": lambda **kw: get_fused_detections(context, **kw),
        "get_review_queue": lambda **kw: get_review_queue(context, **kw),
