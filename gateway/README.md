...
The stdio server supports `initialize`, `tools/list`, `tools/call`, and `ping` in both `legacy-2024` and `stateless-2026` protocol modes, exposing all 46 tools (35 auto-approved / 11 gated). The Oh-Ben-Claw adapter (`brain/oh-ben-claw-adapter/`) consumes it; see `clawcam_gateway/mcp_server/README.md`.
